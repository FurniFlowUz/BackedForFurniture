...
/// <summary>
/// Validator for CreateWarehouseItemDto
/// </summary>
public class CreateWarehouseItemDtoValidator : AbstractValidator<CreateWarehouseItemDto>
{
    public CreateWarehouseItemDtoValidator()
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.CurrentStock)
            ...
            .LessThanOrEqualTo(999999999).WithMessage("Current stock is too large.");
